...
fun.plot_data(daily_data, dformat='daily', plot_type='candle', title='TSLA Daily Data')

# Load and plot tick data
tick_data = fun.load_data('../data/100_tick_tsla.csv', date_col='Date', time_col='Time')
print("Tick data:")
print(tick_data.head())
fun.plot_data(tick_data, dformat='tick', plot_type='candle', title='TSLA Tick Data: Close Price Over Time')

# Load and plot minute data
minute_data = fun.load_data('../data/one_minute_tsla.csv', date_col='Date', time_col='Time')
print("Minute data:")
print(minute_data.head())
fun.plot_data(minute_data, dformat='minute', title='TSLA Minute Data: Close Price Over Time', add_sessions=True)
...
fun.plot_data(market_data, dformat='daily', title='Random Walk Market Data: Close Price Over Time')
